  ...
  return (
    <div className="flex-1 flex flex-col h-full py-3 sm:py-4 md:py-6 lg:py-8 bg-white px-3 sm:px-4 md:px-6 lg:px-8">
      ...
      <div className="mb-4 sm:mb-6">
        <div className="p-4 sm:p-6 md:p-8 border-2 border-dashed border-gray-200 rounded-lg sm:rounded-xl bg-gray-50/50">
...
export function UploadsListSkeleton() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
      {[1, 2, 3, 4, 5, 6].map((i) => (
        <div key={i} className="flex items-center gap-2 sm:gap-3 md:gap-4 p-3 sm:p-4 border-2 border-gray-200 rounded-xl sm:rounded-2xl">
